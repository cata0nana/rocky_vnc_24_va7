...
echo "y" | /opt/android-sdk/cmdline-tools/tools/bin/sdkmanager "system-images;android-24;google_apis;arm64-v8a"
echo "no" | /opt/android-sdk/cmdline-tools/tools/bin/avdmanager create avd -n "my_avd_24_arm" -k "system-images;android-24;google_apis;arm64-v8a"
